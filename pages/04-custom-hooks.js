...
export const CustomHook = () => {
  ...
  const handleSetLocalStorageValue = () => {
    localStorage
      .setItem(localStorageKey, inputValue);
  ...
  return (
    <>
      <p className={styles.challengeDescription}>
        Complete the challenge in the <code>pages/04-custom-hook.js</code> file.<br/>
      </p>
      ...
      <div className={styles.challengeWindow}>
        ...
        <div className={styles.challenges}>
          <button onClick={handleAlertLocalStorageValue} className={styles.actionButton} style={{width: '100%'}}>
          ...
          <button className={styles.actionButton} style={{width: '100%'}} onClick={handleSetLocalStorageValue}>
